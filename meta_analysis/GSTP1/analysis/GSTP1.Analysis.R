# pipeline meta analysis for GSTP1 methylation diagnostic role in NSCLC. 
setwd("/home/sguo/Dropbox/Project/methylation/meta/GSTP1/analysis")
setwd("C:/Users/shicheng/Dropbox/Project/methylation/meta/GSTP1/analysis")
library("meta")
library("metafor")
library("mada")
...
write.table(meta1,file="meta.object.txt",col.names=NA,row.names=T,sep="\t",quote=F)
...
cum<-metacum(meta1,sortvar=gstp1$year,pooled="fix")
...
pdf("SROC2.pdf")
plot(fit.roc, xlim = c(0,0.7), ylim = c(0,0.75),main = "Diagnostic SROC(bivariate model) for GSTP1 in NSCLC",cex.main=1,cex.lab=1,cex.axis=1,lwd=4,lty=1)
