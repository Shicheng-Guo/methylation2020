...
setwd("/home/shg047/monod/phase3/enrichmentAnalysis/")
...
for(i in ref){
  print(i)
  bed1="/home/shg047/monod/phase3/WGBS_pooled_mappable_bins.mld_blocks_r2-0.5.bed"
  ...
  rlt<-bedEnrichmentTest(bed1=bed1,bed2=bed2,excl=excl,iteration=10000,assembly)
...
for(i in ref){
  print(i)
  bed2="/home/shg047/monod/phase3/WGBS_pooled_mappable_bins.mld_blocks_r2-0.5.bed"
  bed1=paste("/home/shg047/db/hg19/",i,sep="")
  excl="/home/shg047/db/hg19/CRGmapability.hg19.exclude.bed"
  assembly="hg19"
  nbed1=read.table(bed1)
  nbed2=read.table(bed2)
