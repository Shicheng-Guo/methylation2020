...
## association between Methylation haplotype block and LDA
## load the function which is at the end of the code
...
lda<-read.table("LAD.hg19.bed4",sep="\t",as.is=T)

setwd("/home/sguo/monod/phase3")
data<-read.table("WGBS_pooled_mappable_bins.mld_blocks_r2-0.5.bed",sep="\t",as.is=T)

rlt<-bedEnrichmentTest("/home/sguo/annotation/LOCK.hg19.bed4","/home/sguo/monod/phase3/WGBS_pooled_mappable_bins.mld_blocks_r2-0.5.bed",assembly="hg19",iteration=1000000)

save(rlt,file="LDA.MHB.RData")
