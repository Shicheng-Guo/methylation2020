...
We meet together with Dr.Zhang, Dinh and discussion. Dinh think She need PCA analysis result to Figure 3A. 
...
pheno=pheno
output="MONOD-WGBS-PCA-PLOT-5.0.3-totalData"
multifigure=F
PCAPlot(data,pheno,output,multifigure=F)
dim(data)
