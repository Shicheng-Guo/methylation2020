...
my $hgsid = "732066787_IyEQKNTUv1nI48AgROHdZigzff3h";  # change it each time when you open your chorsome

my $DIR = getcwd;       
chdir $DIR or die "Cannot change to the $DIR:$!";
my $file = "Second183.hg19.bed";    #the coord_file to be download sequence
my $address;
